...
void GAIA::PipelineManager::CreateGraphicsPipeline()
{
...
std::vector<char> GAIA::PipelineManager::ReadFile(const std::string& filepath)
{

	return std::vector<char>();
}

VkShaderModule GAIA::PipelineManager::CreateShaderModule(const std::vector<char>& code)
{
